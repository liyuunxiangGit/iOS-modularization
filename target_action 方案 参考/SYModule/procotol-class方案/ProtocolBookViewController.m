...
@interface ProtocolBookViewController ()
@property (nonatomic,strong)UILabel *descLb;

@property (nonatomic,strong)UILabel *bookLb;
@end

@implementation ProtocolBookViewController
...
- (void)viewDidLoad {
    ...
    self.bookLb.text = [NSString stringWithFormat:@"我的ID是%@",self.bookLb];
}
